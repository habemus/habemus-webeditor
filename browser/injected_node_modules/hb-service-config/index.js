...
function loadConfig() {
  ...
  return new Bluebird((resolve, reject) => {
    ...
    if (!parsedURL.query || !parsedURL.query.projectCode) {
      throw new Error('`projectCode` must be provided as query parameter');
    }

    var projectCode = parsedURL.query.projectCode;
    ...
    resolve({
      ...
      // hDevServerURI: 'http://localhost:5002',
      authToken: authToken,
      projectId: parsedURL.query.projectCode,
      projectName: parsedURL.query.projectCode,
